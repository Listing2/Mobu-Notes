...
| [retargeting-cleanup.md](retargeting-cleanup.md) | **실무 절차·체크리스트** — Phase 0~6 단계 |
| (작성 예정) `character-setup.md` | VRM/FBX → Mobu characterize, 씬 템플릿 |
| (작성 예정) `export-presets.md` | FBX export 프리셋·네이밍 |

## 외부 도구

- [external-tools.md](../external-tools.md) — Retargeter, OpenMoBu, Cursor 스텁
- [ai-motion-cleanup.md](../ai-motion-cleanup.md) — AI · ML · 코딩 클린업
- [installation.md](../installation.md) — Mobu 2025 폴더 경로
