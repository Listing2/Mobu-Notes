...
| 스크립트 | 설명 | 상태 |
|----------|------|------|
| [vendor/retargeter/retargeter.py](vendor/retargeter/retargeter.py) | [eksod/Retargeter](https://github.com/eksod/Retargeter) — FBX 폴더 일괄 merge·retarget | Mobu `Scripts\Retargeter.py`에 배치 |
