...
| 모드 | 흐름 | 문서 |
|------|------|------|
| **live** | 모캡 → Mobu 송출 → Unity 실시간 → 방송 | 아래 § live |
| **post** | 모캡 FBX → Mobu 리타겟·클린업 → FBX → Unity | [post/](../../post/) |
...
모션캡처 프로그램 (녹화 FBX)
    ↓
MotionBuilder (리타겟·Control Rig 클린업·export)
    ↓
Unity (FBX import · Timeline / Cinemachine)
```

→ [post/workflows/retargeting-cleanup.md](../../post/workflows/retargeting-cleanup.md)
...
| Mobu 송출 fps | MotionBuilder | [motionbuilder/](../motionbuilder/) |
