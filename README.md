...
모션캡처 스튜디오에서 쓰는 **Mobu → Unity → 방송** 파이프라인의 설정, 트러블슈팅, 운영 노트를 모읍니다.

## 목적

- MotionBuilder 송출/수신 설정을 한곳에 기록
- **리타게팅·클린업** 등 Mobu 실무 작업 절차 정리 ([mobu/](mobu/))
...
| 경로 | 내용 |
|------|------|
| [mobu/](mobu/) | **Mobu 2025 실무** — 리타게팅·클린업·스크립트 |
...
- [리타게팅 개념 정리](mobu/workflows/retargeting-fundamentals.md)
- [리타게팅·클린업 실무 절차](mobu/workflows/retargeting-cleanup.md)
...
- [Listing2 / Repositories](https://github.com/Listing2?tab=repositories) — 기타 관련 저장소
